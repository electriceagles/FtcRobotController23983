...
/**
 * AutoThreeArtifactsRed runs a simple autonomous routine for the RED alliance.
 *
 * <p>This OpMode mirrors {@link AutoThreeArtifacts} for the RED alliance side
 * of the field. The only difference is the strafe direction when navigating
 * to the classifier - RED strafes LEFT instead of RIGHT.</p>
 *
 ...
 */
@Config
@Autonomous(name = "Auto 3 Artifacts RED", group = "Auto")
public class AutoThreeArtifactsRed extends BaseAutoOpMode {

    // ========================================================================
    // TUNABLE PARAMETERS (adjustable via FTC Dashboard)
    // These can be tuned separately from BLUE if the field isn't symmetric
    // ========================================================================
    ...
    // Alliance-specific: Red strafes LEFT to reach classifier
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("=== AUTO 3 ARTIFACTS RED ===");
        ...
        // Red alliance: strafe LEFT then drive forward
